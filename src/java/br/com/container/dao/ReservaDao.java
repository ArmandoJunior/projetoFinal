...
//    List<GraficoReservaPorMesSala> totalMesSala(Session session) throws HibernateException; 
    
    List<ChartReservaMes> totalMesSala(Session session) throws HibernateException;
}
